...
function isNetworkIsolationEnabled(network) {
    ...
    initializationPromise = (async () => {
        try {
            if (!isNetworkIsolationEnabled(config.network)) {
                ...
                logForDebugging('Network isolation disabled; skipping network infrastructure');
                return context;
            }
...
async function wrapWithSandbox(command, binShell, customConfig, abortSignal) {
    ...
    const networkIsolationEnabled = isNetworkIsolationEnabled(effectiveNetworkConfig);
    const hasNetworkConfig = networkIsolationEnabled &&
...
export const SandboxManager = {
    ...
    getConfig,
    updateConfig,
};//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/df53daabb18cd157bdb08c7f01c34df936cf12f4/node_modules/@vscode/sandbox-runtime/dist/sandbox/sandbox-manager.js.map