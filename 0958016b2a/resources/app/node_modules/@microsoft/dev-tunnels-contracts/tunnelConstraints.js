...
(function (TunnelConstraints) {
     ...
     */
    TunnelConstraints.newTunnelIdMaxLength = 49;
    /**
     ...
     * (-&lt;port&gt;-inspect) remain within the DNS label limit of 63 characters.
     */
    TunnelConstraints.tunnelNameMaxLength = 49;
    /**
     * Max length of SSH username.
     */
    TunnelConstraints.sshUserMaxLength = 60;
    /**
     ...
     */
    TunnelConstraints.eventDetailsMaxLength = 4000;
    /**
     * Max number of properties in a tunnel event.
     */
    TunnelConstraints.maxEventProperties = 100;
    /**
     * Max length of a single tunnel event property value.
     */
    TunnelConstraints.eventPropertyValueMaxLength = 4000;
    /**
     ...
     */
    TunnelConstraints.eventNamePattern = '^[a-z0-9_]{3,80}$';
    /**
     * Regular expression that can match or validate tunnel event severity strings.
     */
    TunnelConstraints.eventSeverityPattern = '^(info)|(warning)|(error)$';
    /**
     * Regular expression that can match or validate tunnel event property name strings.
     */
    TunnelConstraints.eventPropertyNamePattern = '^[a-zA-Z0-9_.]{3,200}$';
    /**
     ...
     * Cluster IDs are alphanumeric; hyphens are not permitted.
     */
    TunnelConstraints.clusterIdPrefixRegex = new RegExp(TunnelConstraints.clusterIdPattern.replace('$', '\\.'));
    /**
     ...
     */
    TunnelConstraints.newTunnelIdPattern = '[a-z0-9][a-z0-9-]{1,47}[a-z0-9]';
    /**
     * Regular expression that can match or validate tunnel ID strings.
     *
     * Tunnel IDs are fixed-length and have a limited character set of numbers and
     ...
     * characters.
     */
    TunnelConstraints.tunnelAliasPattern = '[' + TunnelConstraints.tunnelAliasChars + ']{3,49}';
    /**
     * Regular expression that can match or validate tunnel alias strings.
     *
     * Tunnel Aliases are fixed-length and have a limited character set of numbers and
     ...
     * 63 characters.
     */
    TunnelConstraints.tunnelNamePattern = '([a-z0-9][a-z0-9-]{1,47}[a-z0-9])|(^$)';
    /**
     * Regular expression that can match or validate tunnel names.
     *
     * Tunnel names are alphanumeric and may contain hyphens. The pattern also allows an
...
})(TunnelConstraints = exports.TunnelConstraints || (exports.TunnelConstraints = {}));//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/0958016b2af9f09bb4257e0df4a95e2f90590f9f/node_modules/@microsoft/dev-tunnels-contracts/tunnelConstraints.js.map