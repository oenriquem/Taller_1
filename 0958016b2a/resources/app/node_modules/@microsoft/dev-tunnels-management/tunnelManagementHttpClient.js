...
class TunnelManagementHttpClient {
     ...
     */
    static forCustomDomain(customDomain, userAgents, apiVersion, userTokenCallback, httpsAgent, adapter) {
        if (!customDomain) {
            throw new TypeError('Custom domain must be a non-empty string.');
        }
        const serviceUri = `https://cp.${customDomain}/`;
        return new TunnelManagementHttpClient(userAgents, apiVersion, userTokenCallback, serviceUri, httpsAgent, adapter);
    }
    ...
    reportEvent(tunnel, tunnelEvent, options) {
        ...
        (_a = tunnelEvent.timestamp) !== null && _a !== void 0 ? _a : (tunnelEvent.timestamp = new Date());
    ...
    async processPendingEventsAsync() {
        ...
        while (!this.isDisposed) {
            ...
            try {
                ...
                await this.request('POST', uri, [...eventsToSend], // Create a copy to avoid mutation issues
    ...
    async buildUri(clusterId, path, query, options) {
        ...
        if (clusterId && !this.isCustomDomain) {
            ...
            url.hostname = TunnelManagementHttpClient.replaceTunnelServiceHostnameClusterId(url.hostname, clusterId);
    ...
    static replaceTunnelServiceHostnameClusterId(hostname, clusterId) {
        ...
        if (hostname.startsWith('global.') ||
            dev_tunnels_contracts_1.TunnelConstraints.clusterIdPrefixRegex.test(hostname)) {
...
exports.TunnelManagementHttpClient = TunnelManagementHttpClient;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/0958016b2af9f09bb4257e0df4a95e2f90590f9f/node_modules/@microsoft/dev-tunnels-management/tunnelManagementHttpClient.js.map