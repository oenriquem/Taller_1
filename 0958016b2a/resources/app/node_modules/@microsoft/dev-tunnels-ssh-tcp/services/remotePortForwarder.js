...
class RemotePortForwarder extends remotePortConnector_1.RemotePortConnector {
    ...
    static async forwardChannel(pfs, request, localHost, localPort, remotePort, trace, cancellation) {
        ...
        try {
            ...
            trace(dev_tunnels_ssh_1.TraceLevel.Warning, dev_tunnels_ssh_1.SshTraceEventIds.portForwardConnectionFailed, `PortForwardingService connection ` +
                `to ${localHost}:${localPort} failed: ${e.message}`, e);
            request.failureReason = dev_tunnels_ssh_1.SshChannelOpenFailureReason.connectFailed;
...
exports.RemotePortForwarder = RemotePortForwarder;//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/0958016b2af9f09bb4257e0df4a95e2f90590f9f/node_modules/@microsoft/dev-tunnels-ssh-tcp/services/remotePortForwarder.js.map